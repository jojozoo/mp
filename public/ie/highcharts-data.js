$(function () {
	$('#highcharts0').highcharts({
		...
		series: [{
			name: '用户注册',
			data: [67, 78, 96, 52, 95, 15, 8, 63, 21, 91, 98, 39, 60, 89, 80, 49, 64, 98, 88, 70, 46, 85, 56, 89]
		}, {
			name: '图片上传',
			data: [7, 66, 37, 90, 66, 4, 69, 34, 10, 96, 4, 40, 85, 39, 57, 10, 59, 81, 88, 43, 80, 46, 20, 2]
		}, {
			name: '动态数据',
			data: [44, 52, 66, 84, 45, 39, 36, 65, 71, 57, 72, 57, 38, 88, 34, 68, 55, 54, 81, 2, 0, 4, 49, 49]
		}]
	});
	...
	$('#highcharts1').highcharts({
        ...
        title: {
            text: '漫拍网 2012/12/28 production.log 统计'
        },
        subtitle: {
            // text: document.ontouchstart === undefined ? '数据来源: 日志分析工具 (左右拖拽可放大缩小)' : '数据来源: 日志分析工具 (可放大缩小)'
            text: '来自日志分析系统: request-log-analyzer'
        },
        xAxis: {
            type: 'datetime',
