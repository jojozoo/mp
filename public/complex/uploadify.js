		...
		init : function(options, swfUploadOptions) {
			...
			return this.each(function() {
				...
				var settings = $.extend({
					...
					fileTypeExts    : '*.jpg; *.png; *.jpeg; *.JPG; *.PNG; *.JPEG',              // Allowed extensions in the browse dialog (server-side validation should also be used)
	...
	var handlers = {
		...
		onSelect : function(file) {
			...
			if (settings.itemTemplate == false) {
				...
				settings.itemTemplate = '<div class="col-md-12" id="${fileID}">\
								<div class="framebox">\
									<img src="/images/default_upload_photo.jpg" class="edit-pic z-tag">\
									<i class="setcover"></i>\
								...
								<div class="photoopt">\
									...
									<a href="javascript:void(0);" class="gotocover">\
										封面\
									</a>\
									<a href="javascript:void(0);" class="gotodel">\
										删除\
									</a>\
									<a href="javascript:void(0);"  class="gotobottom">\
										<span>\
											<i class="icon-chevron-down"></i>\
										</span>\
									</a>\
								</div>\
								<textarea style="width:900px;height:112px;float:left;"></textarea>\
							</div>';
			}
			...
			if ($.inArray('onSelect', settings.overrideEvents) < 0) {
				...
				$('#' + settings.queueID).find(".upcm2").before(itemHTML);
			}
						...
						case SWFUpload.FILE_STATUS.COMPLETE:
							setTimeout(function() { 
								if ($('#' + file.id)) {
									...
									$('#' + file.id).find(".framebox span,.framebox div").fadeOut(300, function() {
										$(this).remove();
									});
								}
