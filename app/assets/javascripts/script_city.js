...
function showprovince(provinceid, cityid, province, boxid) {
	var provinces = new Array(
		"北京", "上海", "浙江", "广东", "山东", "四川", "重庆", "江苏", "安徽", "福建", "甘肃", "广西", "贵州", "海南", "河北", "黑龙江", "河南",
		"香港", "湖北", "湖南", "江西", "吉林", "辽宁", "澳门", "内蒙古", "宁夏", "青海",
		"山西", "陕西", "台湾", "天津", "新疆", "西藏", "云南", "海外"
	);
...
function changectity(provinceid, cityid,currentcity){
	...
	for(var i = 0; i < cityOptions.length/2; i++) {
		j = i + 1;
		if(currentcity == cityOptions[i*2+1]){
		cityObject.innerHTML +='<a onclick="clickcitys(\''+cityOptions[i*2+1]+'\')" title="'+ cityOptions[i*2+1] +'" class="cityclass">'+cityOptions[i*2]+'</a>' ;
		}else{
		cityObject.innerHTML +='<a onclick="clickcitys(\''+cityOptions[i*2+1]+'\')" title="'+ cityOptions[i*2+1] +'" >'+cityOptions[i*2]+'</a>' ;	
		}
	}
