...
(function(a){
    a.fn.desSlideshow=function(p){
        ...
        function init(){
            ...
            g.find(".switchBigPic").children("div").children("p").css("position","absolute").css("padding","10px").css("margin","0px").css("bottom","0px").css("opacity","0.6").css("background-color","#000").css("color","#FFF").css("font-size","14px").css("width","100%");
            ...
            g.find(".nav").children("li").children("a")
									...
									//.css("font-size","14px");
            g.find(".nav").children("li").css("float","left")
									.css("height","11px")
									.css("display","block")
									.css("width","11px")
									.css("margin-left","4px");
        ...
        function showpic(){
            clearTimeout(v);
            g.find(".nav").children("li")
									.css("background-image","url("+directory+"banner_btn02.png)")
									//.css("border-bottom","1px solid #CCCCCC");
            g.find(".nav").children("li").eq(current)
									.css("background-image","url("+directory+"banner_btn01.png)")
